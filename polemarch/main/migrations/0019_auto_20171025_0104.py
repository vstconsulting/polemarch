...
import polemarch.main.models.acl_models
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='group',
            name='owner',
            field=models.ForeignKey(related_name='polemarch_group_set', default=polemarch.main.models.acl_models.first_staff_user, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='host',
            name='owner',
            field=models.ForeignKey(related_name='polemarch_host_set', default=polemarch.main.models.acl_models.first_staff_user, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='inventory',
            name='owner',
            field=models.ForeignKey(related_name='polemarch_inventory_set', default=polemarch.main.models.acl_models.first_staff_user, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='periodictask',
            name='owner',
            field=models.ForeignKey(related_name='polemarch_periodictask_set', default=polemarch.main.models.acl_models.first_staff_user, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='project',
            name='owner',
            field=models.ForeignKey(related_name='polemarch_project_set', default=polemarch.main.models.acl_models.first_staff_user, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='template',
            name='owner',
            field=models.ForeignKey(related_name='polemarch_template_set', default=polemarch.main.models.acl_models.first_staff_user, to=settings.AUTH_USER_MODEL),
        ),
