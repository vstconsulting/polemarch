...
guiElements.ansible_json = function(opt = {}, value)
{
     ...
     * @param realElements(object) - fields of ansible_json value
     */
    this.setTypesOfValueField = function(value, realElements)
    {
        let fields_types = {
        ...
        for (let field in value)
        {
            ...
            if ((typeof value[field] == "string" && value[field] == "") || (Array.isArray(value[field]) && value[field].length == 0)) {
                type = 'hidden';
            }
    ...
    this.setValue = function(value)
    {
        ...
        if(value)
        {
            ...
            realElements = this.setTypesOfValueField(value, realElements);
        }
