 ...
 */
tests.runner.module('guiViews[project]', null, () => {
            ...
            new: [
                {
                    ...
                    data: {
                        ...
                        // type:{value: "MANUAL",},
                        type: { value: 'GIT' },
                        repository: { value: 'https://github.com/vstconsulting/ansible-test.git' },
                    },
                },
            ],
            edit: [
    ...
    guiTests.copyInstanceFromPageView(page_path, instances_info, {
        ...
        remove: true,
        data: {
            name: { value: spa.utils.randomString(8) },
        },
    });
    ...
    guiTests.testSetOfViews(
        ...
        instances_info,
        {
            ...
            add_child: {
                ...
                data: {
                    name: {
                        value: 'child-inventory-' + spa.utils.randomString(6) + spa.utils.randomString(6),
                    },
                },
            },
        },
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'inventory/{inventory_id}/variables/',
        instances_info,
        {
            new: [
                {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'inventory/{inventory_id}/group/',
        instances_info,
        {
            new: [
                {
                    ...
                    data: {
                        name: { value: spa.utils.randomString(6) },
                        notes: { value: spa.utils.randomString(6) },
                    },
                },
            ],
            edit: [
                {
                    is_valid: true,
                    data: {
                        notes: { value: spa.utils.randomString(6) + spa.utils.randomString(6) },
                    },
                },
            ],
            add_child: {
                ...
                data: {
                    name: {
                        value: 'child-group-' + spa.utils.randomString(6) + spa.utils.randomString(6),
                    },
                },
            },
        },
    ...
    ////////////////////////////////////////////////////////////////////////////////////
    guiTests.executeActionFromSomeView(
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'inventory/{inventory_id}/group/{group_id}/variables/',
        instances_info,
        {
            new: [
                {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'inventory/{inventory_id}/group/{group_id}/host/',
        instances_info,
        {
            new: [
                {
            ...
            add_child: {
                ...
                data: {
                    name: {
                        value: 'child-host-' + spa.utils.randomString(6) + spa.utils.randomString(6),
                    },
                },
            },
            page: {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'inventory/{inventory_id}/host/',
        instances_info,
        {
            new: [
                {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'inventory/{inventory_id}/host/{host_id}/variables/',
        instances_info,
        {
            new: [
                {
    ...
    guiTests.openPage(
        page_path + 'inventory/{inventory_id}/all_groups/{group_id}/',
    ...
    guiTests.openPage(
        page_path + 'inventory/{inventory_id}/all_hosts/{host_id}/',
        instances_info.url_params,
        true,
    );
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'template/{template_id}/variables/',
        instances_info,
        {
            new: [
                {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'template/{template_id}/option/{option_id}/variables/',
        instances_info,
        {
            new: [
                {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    guiTests.testSetOfViews(
        page_path + 'periodic_task/{periodic_task_id}/variables/',
        instances_info,
        {
            new: [
                {
...
tests.runner.module('guiViews[community_template]', null, () => {
    ...
    tests.runner.test('check quick playbook run form existence', function (assert) {
    ...
    tests.runner.test('check community playbooks existence', function (assert) {
