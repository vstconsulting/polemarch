 ...
 */
tests.runner.module('guiFields[field].{toInner, toRepresent}() - PM');
        ...
        values: [
            {
                ...
                output: {
                    ...
                    toRepresent: moment(moment.tz('2019-05-08T07:08:07', app.api.getTimeZone()))
                        .tz(moment.tz.guess())
...
for (let item of Object.values(fields_constructor)) {
    tests.fields.addTestForGuiFieldInstanceMethods($.extend(true, {}, base_opt, item.options), item.values);
}
